...
function Footer1() {
  return (
        ...
        <div id="contact" className="row align-items-center g-lg-5">
          <div className="col-lg-7 text-center text-lg-start">
            ...
            <p className="poppins-regular col-lg-10 text-white fs-5">
              Reach out to me for collaborations, read my blogs, or connect with
            ...
            <>
              <div className="social-buttons">
                ...
                <a
                  href="https://www.linkedin.com/in/ayush-sri/"
                ...
                <a
                  href="https://www.facebook.com/profile.php?id=100008666706409"
    ...
    c-2.762,0-5,2.238-5,5v50.844C76.703,162.867,78.941,165.106,81.703,165.106z"
                ...
                <a
                  href="https://www.instagram.com/axxyush/"
            ...
            <>
              ...
              >
                <span className="custom-actual-text poppins-regular">
                  &nbsp;Blogs&nbsp;
                </span>
                <span
                  aria-hidden="true"
                  className="custom-hover-text poppins-regular"
                >
                  &nbsp;Blogs&nbsp;
                </span>
              </a>
